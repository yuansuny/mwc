...
static struct feature_node *x_space;
static struct parameter param;
static struct problem prob;
static struct model* model_;
static int flag_cross_validation;
static int flag_find_C;
static int flag_C_specified;
static int flag_solver_specified;
static int nr_fold;
static double bias;
...
int linear_svm_train_model(char input_file_name[], char model_file_name[], double weight1)
{
...
//	param.weight = NULL;
	...
	param.weight[param.nr_weight-1] = weight1;
