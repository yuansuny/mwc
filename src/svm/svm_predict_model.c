...
static int predict_probability=1;
...
int svm_predict_model(char input_file[], char model_file[], char output_file[], int probability)
{
	FILE *input, *output;

//	char input_file[] = "heart_scale";
//	char output_file[] = "output";
//	char model_file[] = "heart_scale.model";
